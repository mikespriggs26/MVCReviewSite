...
namespace MVCReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserName,Location,PublishedDate,Content,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserName,Location,PublishedDate,Content,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
